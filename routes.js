...
const { homepage, lists, createList, createItem, compareItems, getList, getNextComparison, logout, login, signup, deleteList, deleteItem, resetItem, resetListComparisons, resetComparison, setListPublicity, renameList, renderRenamePage } = require('./controllers.js');
