...
export default function Main({ url, user, message, children }) {
	return (
		<html lang="en">
			...
			<body>
				<a href="https://github.com/RascalTwo/PairwiseSorter" className="github-corner fixed-top" aria-label="View source on GitHub"><svg width="80" height="80" viewBox="0 0 250 250" style={{
					fill: '#70B7FD',
					color: '#fff',
					position: 'absolute',
					top: 0,
